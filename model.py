...
img_sizeA = img_heightA * img_widthA
img_sizeB = img_heightB * img_widthB
...
def build_generator_resnet_6blocks(inputgen,img_layer ,name="generator"):
    with tf.variable_scope(name):
        f = 7
        ks = 3
...
def build_generator_resnet_9blocks(inputgen, img_layer, name="generator"):
    with tf.variable_scope(name):
        f = 7
        ks = 3
