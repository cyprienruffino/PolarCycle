...
#*****************************************************************************************************
def EvalImageConstraintC1(x, name="ImageConstraintC1"):
...
def ProcessInputImgA(f="./input/rgb2pol/trainA"):
    ...
    for i in range(max_img):
        ...
        image_resized = image_resized.reshape((batch_size,img_height, img_width, img_layer_A))
        print("A : ", image_resized.shape)
        X.append(image_resized)
        
    print("Process Input ImgA has done ...")
    os.chdir(path)
    return X
...
def ProcessInputImgB(f="./input/rgb2pol/trainB"):
    ...
    for i in range(max_img):
        ...
        if I0==None or I45==None or I90==None or I135==None:
            ...
            print("B : ", merged.shape)
            X.append(merged)
            
    print("Process Input ImgB has done ...")
    os.chdir(path)
    return X
