...
def create_network(inp, channels_out, name):
    with tf.name_scope(name):
        ...
        layer = kl.Conv2D(64, 3, padding="same", strides=2)(layer)
        layer = cl.InstanceNormalization()(layer)
        layer = kl.Activation("relu")(layer)
        ...
        # Transformer
        layer = cl.ResidualBlock(128, nb_layers=2, kernel_size=3, normalization="instancenorm")(layer)
        layer = cl.ResidualBlock(128, nb_layers=2, kernel_size=3, normalization="instancenorm")(layer)
        layer = cl.ResidualBlock(128, nb_layers=2, kernel_size=3, normalization="instancenorm")(layer)
        layer = cl.ResidualBlock(128, nb_layers=2, kernel_size=3, normalization="instancenorm")(layer)
        layer = cl.ResidualBlock(128, nb_layers=2, kernel_size=3, normalization="instancenorm")(layer)
        ...
        G_out = kl.Conv2D(channels_out, 3, strides=1, activation="tanh", padding="same")(layer)
